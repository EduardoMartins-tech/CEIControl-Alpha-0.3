<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <?php elseif ($_SESSION['perfil'] == 'usuario'): ?>
            <a href="painel_usuario.php"><i class="fa-solid fa-chalkboard-user"></i> Minha Sala</a>
            <p class="nav-category">Rotina</p>
            <a href="listar_eventos.php"><i class="fa-solid fa-calendar-check"></i> Agenda Escolar</a>
            <a href="listar_produtos.php"><i class="fa-solid fa-box-archive"></i> Materiais</a>

        <?php elseif ($_SESSION['perfil'] == 'cliente'): ?>
            <a href="painel_cliente.php"><i class="fa-solid fa-house-user"></i> Visão Geral</a>
