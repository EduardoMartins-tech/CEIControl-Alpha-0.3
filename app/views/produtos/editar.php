...
if (!isset($_GET['id'])) {
    header("Location: /produtos?erro=id_invalido");
    exit;
}
...
if (!$produto) {
    header("Location: /produtos?erro=nao_encontrado");
    exit;
}
...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <header class="dash-header">
            ...
            <a href="/produtos" class="btn-black-full" style="width:auto;padding:10px 25px;background:#666;">
        ...
        <section class="content-wrapper">
            <div class="admin-card" style="max-width:600px;margin:0 auto;display:block;">
                <form action="/produtos/atualizar" method="POST" class="custom-form">
