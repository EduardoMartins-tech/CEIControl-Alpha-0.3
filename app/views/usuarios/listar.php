...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <header class="dash-header">
            ...
            <a href="form_cadastro.php" class="btn-black-full" style="width:auto;padding:10px 25px;">
                        ...
                        <?php if ($result && $result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <a href="editar.php?id=<?= $row['id']; ?>" class="edit-btn" title="Editar">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="excluir.php?id=<?= $row['id']; ?>" class="delete-btn" title="Excluir"
