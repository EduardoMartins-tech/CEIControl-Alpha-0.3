...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <header class="dash-header">
            ...
            <a href="/usuarios/cadastro" class="btn-black-full" style="width:auto;padding:10px 25px;">
                        ...
                        <?php if ($result && $result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <a href="/usuarios/editar?id=<?= $row['id']; ?>" class="edit-btn" title="Editar">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="/usuarios/excluir?id=<?= $row['id']; ?>" class="delete-btn" title="Excluir"
